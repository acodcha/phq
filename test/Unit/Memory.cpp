...
TEST(UnitMemory, ConvertFromStandard) {
  ...
  Internal::TestConversions(Memory::Bit, Memory::Kilobit, value, value / 1000.0);
  Internal::TestConversions(Memory::Bit, Memory::Kibibit, value, value / 1024.0);
  Internal::TestConversions(Memory::Bit, Memory::Kilobyte, value, value / (8.0 * 1000.0));
  Internal::TestConversions(Memory::Bit, Memory::Kibibyte, value, value / (8.0 * 1024.0));
  Internal::TestConversions(Memory::Bit, Memory::Megabit, value, value / std::pow(1000.0, 2));
  Internal::TestConversions(Memory::Bit, Memory::Mebibit, value, value / std::pow(1024.0, 2));
  Internal::TestConversions(
      Memory::Bit, Memory::Megabyte, value, value / (8.0 * std::pow(1000.0, 2)));
  Internal::TestConversions(
      Memory::Bit, Memory::Mebibyte, value, value / (8.0 * std::pow(1024.0, 2)));
  Internal::TestConversions(Memory::Bit, Memory::Gigabit, value, value / std::pow(1000.0, 3));
  Internal::TestConversions(Memory::Bit, Memory::Gibibit, value, value / std::pow(1024.0, 3));
  Internal::TestConversions(
      Memory::Bit, Memory::Gigabyte, value, value / (8.0 * std::pow(1000.0, 3)));
  Internal::TestConversions(
      Memory::Bit, Memory::Gibibyte, value, value / (8.0 * std::pow(1024.0, 3)));
  Internal::TestConversions(Memory::Bit, Memory::Terabit, value, value / std::pow(1000.0, 4));
  Internal::TestConversions(Memory::Bit, Memory::Tebibit, value, value / std::pow(1024.0, 4));
  Internal::TestConversions(
      Memory::Bit, Memory::Terabyte, value, value / (8.0 * std::pow(1000.0, 4)));
  Internal::TestConversions(
      Memory::Bit, Memory::Tebibyte, value, value / (8.0 * std::pow(1024.0, 4)));
  Internal::TestConversions(Memory::Bit, Memory::Petabit, value, value / std::pow(1000.0, 5));
  Internal::TestConversions(Memory::Bit, Memory::Pebibit, value, value / std::pow(1024.0, 5));
  Internal::TestConversions(
      Memory::Bit, Memory::Petabyte, value, value / (8.0 * std::pow(1000.0, 5)));
  Internal::TestConversions(
      Memory::Bit, Memory::Pebibyte, value, value / (8.0 * std::pow(1024.0, 5)));

  Internal::TestStaticConversions<Memory, Memory::Bit, Memory::Kibibyte>(
...
TEST(UnitMemory, ConvertToStandard) {
  ...
  Internal::TestConversions(Memory::Kilobit, Memory::Bit, value, value * 1000.0);
  Internal::TestConversions(Memory::Kibibit, Memory::Bit, value, value * 1024.0);
  Internal::TestConversions(Memory::Kilobyte, Memory::Bit, value, value * 8.0 * 1000.0);
  Internal::TestConversions(Memory::Kibibyte, Memory::Bit, value, value * 8.0 * 1024.0);
  Internal::TestConversions(Memory::Megabit, Memory::Bit, value, value * std::pow(1000.0, 2));
  Internal::TestConversions(Memory::Mebibit, Memory::Bit, value, value * std::pow(1024.0, 2));
  Internal::TestConversions(
      Memory::Megabyte, Memory::Bit, value, value * 8.0 * std::pow(1000.0, 2));
  Internal::TestConversions(
      Memory::Mebibyte, Memory::Bit, value, value * 8.0 * std::pow(1024.0, 2));
  Internal::TestConversions(Memory::Gigabit, Memory::Bit, value, value * std::pow(1000.0, 3));
  Internal::TestConversions(Memory::Gibibit, Memory::Bit, value, value * std::pow(1024.0, 3));
  Internal::TestConversions(
      Memory::Gigabyte, Memory::Bit, value, value * 8.0 * std::pow(1000.0, 3));
  Internal::TestConversions(
      Memory::Gibibyte, Memory::Bit, value, value * 8.0 * std::pow(1024.0, 3));
  Internal::TestConversions(Memory::Terabit, Memory::Bit, value, value * std::pow(1000.0, 4));
  Internal::TestConversions(Memory::Tebibit, Memory::Bit, value, value * std::pow(1024.0, 4));
  Internal::TestConversions(
      Memory::Terabyte, Memory::Bit, value, value * 8.0 * std::pow(1000.0, 4));
  Internal::TestConversions(
      Memory::Tebibyte, Memory::Bit, value, value * 8.0 * std::pow(1024.0, 4));
  Internal::TestConversions(Memory::Petabit, Memory::Bit, value, value * std::pow(1000.0, 5));
  Internal::TestConversions(Memory::Pebibit, Memory::Bit, value, value * std::pow(1024.0, 5));
  Internal::TestConversions(
      Memory::Petabyte, Memory::Bit, value, value * 8.0 * std::pow(1000.0, 5));
  Internal::TestConversions(
      Memory::Pebibyte, Memory::Bit, value, value * 8.0 * std::pow(1024.0, 5));

  Internal::TestStaticConversions<Memory, Memory::Kibibyte, Memory::Bit>(
      value, value * 8.0 * 1024.0);
}
