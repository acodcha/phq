...
TEST(UnitMemory, ConvertFromStandard) {
  ...
  Internal::TestUnitConversions<Memory, Memory::Bit, Memory::Byte>(value, value / 8.0);
  Internal::TestUnitConversions<Memory, Memory::Bit, Memory::Kilobit>(value, value / 1000.0);
  Internal::TestUnitConversions<Memory, Memory::Bit, Memory::Kibibit>(value, value / 1024.0);
...
TEST(UnitMemory, ConvertToStandard) {
  constexpr double value{10.0};
  Internal::TestUnitConversions<Memory, Memory::Bit, Memory::Bit>(value, value);
  Internal::TestUnitConversions<Memory, Memory::Byte, Memory::Bit>(value, value * 8.0);
  Internal::TestUnitConversions<Memory, Memory::Kilobit, Memory::Bit>(value, value * 1000.0);
  Internal::TestUnitConversions<Memory, Memory::Kibibit, Memory::Bit>(value, value * 1024.0);
  Internal::TestUnitConversions<Memory, Memory::Kilobyte, Memory::Bit>(value, value * 8.0 * 1000.0);
  Internal::TestUnitConversions<Memory, Memory::Kibibyte, Memory::Bit>(value, value * 8.0 * 1024.0);
