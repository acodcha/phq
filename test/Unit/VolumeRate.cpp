...
TEST(UnitVolumeRate, ConvertFromStandard) {
  ...
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicNauticalMilePerSecond>(
      value, value / std::pow(1852.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMilePerSecond>(value, value / std::pow(1609.344L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicKilometrePerSecond>(
      value, value * std::pow(0.001L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMetrePerSecond>(value, value);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicYardPerSecond>(value, value / std::pow(0.9144L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicFootPerSecond>(value, value / std::pow(0.3048L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicDecimetrePerSecond>(value, value * std::pow(10.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::LitrePerSecond>(value, value * std::pow(10.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicInchPerSecond>(value, value / std::pow(0.0254L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicCentimetrePerSecond>(
      value, value * std::pow(100.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::MillilitrePerSecond>(value, value * std::pow(100.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMillimetrePerSecond>(
      value, value * std::pow(1000.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMilliinchPerSecond>(
      value, value / std::pow(0.0000254L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMicrometrePerSecond>(
      value, value * std::pow(1000000.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMicroinchPerSecond>(
      value, value / std::pow(0.0000000254L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicNauticalMilePerMinute>(
      value, value * 60.0L / std::pow(1852.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMilePerMinute>(
      value, value * 60.0L / std::pow(1609.344L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicKilometrePerMinute>(
      value, value * 60.0L * std::pow(0.001L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMetrePerMinute>(value, value * 60.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicYardPerMinute>(
  ...
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::LitrePerMinute>(value, value * 60.0L * std::pow(10.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicInchPerMinute>(
      value, value * 60.0L / std::pow(0.0254L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicCentimetrePerMinute>(
      value, value * 60.0L * std::pow(100.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::MillilitrePerMinute>(
      value, value * 60.0L * std::pow(100.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
  ...
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMilliinchPerMinute>(
      value, value * 60.0L / std::pow(0.0000254L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMicrometrePerMinute>(
      value, value * 60.0L * std::pow(1000000.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMicroinchPerMinute>(
      value, value * 60.0L / std::pow(0.0000000254L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicNauticalMilePerHour>(
      value, value * 3600.0L / std::pow(1852.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMilePerHour>(
      value, value * 3600.0L / std::pow(1609.344L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicKilometrePerHour>(
      value, value * 3600.0L * std::pow(0.001L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMetrePerHour>(value, value * 3600.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicYardPerHour>(
  ...
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond, VolumeRate::LitrePerHour>(
      value, value * 3600.0L * std::pow(10.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicInchPerHour>(
  ...
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMilliinchPerHour>(
      value, value * 3600.0L / std::pow(0.0000254L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMicrometrePerHour>(
      value, value * 3600.0L * std::pow(1000000.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMicroinchPerHour>(
      value, value * 3600.0L / std::pow(0.0000000254L, 3));
}

TEST(UnitVolumeRate, ConvertToStandard) {
  constexpr long double value{1.234567890123456789L};
  Internal::TestConversions<VolumeRate, VolumeRate::CubicNauticalMilePerSecond,
                            VolumeRate::CubicMetrePerSecond>(value, value * std::pow(1852.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMilePerSecond,
                            VolumeRate::CubicMetrePerSecond>(value, value * std::pow(1609.344L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicKilometrePerSecond,
                            VolumeRate::CubicMetrePerSecond>(value, value * std::pow(1000.0L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerSecond,
                            VolumeRate::CubicMetrePerSecond>(value, value);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicYardPerSecond,
                            VolumeRate::CubicMetrePerSecond>(value, value * std::pow(0.9144L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicFootPerSecond,
                            VolumeRate::CubicMetrePerSecond>(value, value * std::pow(0.3048L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicDecimetrePerSecond,
                            VolumeRate::CubicMetrePerSecond>(value, value * std::pow(0.1L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::LitrePerSecond,
                            VolumeRate::CubicMetrePerSecond>(value, value * std::pow(0.1L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicInchPerSecond,
                            VolumeRate::CubicMetrePerSecond>(value, value * std::pow(0.0254L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicCentimetrePerSecond,
                            VolumeRate::CubicMetrePerSecond>(value, value * std::pow(0.01L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::MillilitrePerSecond,
                            VolumeRate::CubicMetrePerSecond>(value, value * std::pow(0.01L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMillimetrePerSecond,
                            VolumeRate::CubicMetrePerSecond>(value, value * std::pow(0.001L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMilliinchPerSecond,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.0000254L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMicrometrePerSecond,
                            VolumeRate::CubicMetrePerSecond>(value, value * std::pow(0.000001L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMicroinchPerSecond,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.0000000254L, 3));
  Internal::TestConversions<VolumeRate, VolumeRate::CubicNauticalMilePerMinute,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(1852.0L, 3) / 60.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMilePerMinute,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(1609.344L, 3) / 60.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicKilometrePerMinute,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(1000.0L, 3) / 60.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerMinute,
                            VolumeRate::CubicMetrePerSecond>(value, value / 60.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicYardPerMinute,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.9144L, 3) / 60.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicFootPerMinute,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.3048L, 3) / 60.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicDecimetrePerMinute,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.1L, 3) / 60.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::LitrePerMinute,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.1L, 3) / 60.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicInchPerMinute,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.0254L, 3) / 60.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicCentimetrePerMinute,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.01L, 3) / 60.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::MillilitrePerMinute,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.01L, 3) / 60.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMillimetrePerMinute,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.001L, 3) / 60.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMilliinchPerMinute,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.0000254L, 3) / 60.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMicrometrePerMinute,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.000001L, 3) / 60.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMicroinchPerMinute,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.0000000254L, 3) / 60.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicNauticalMilePerHour,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(1852.0L, 3) / 3600.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMilePerHour,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(1609.344L, 3) / 3600.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicKilometrePerHour,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(1000.0L, 3) / 3600.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMetrePerHour,
                            VolumeRate::CubicMetrePerSecond>(value, value / 3600.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicYardPerHour,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.9144L, 3) / 3600.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicFootPerHour,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.3048L, 3) / 3600.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicDecimetrePerHour,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.1L, 3) / 3600.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::LitrePerHour, VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.1L, 3) / 3600.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicInchPerHour,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.0254L, 3) / 3600.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicCentimetrePerHour,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.01L, 3) / 3600.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::MillilitrePerHour,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.01L, 3) / 3600.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMillimetrePerHour,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.001L, 3) / 3600.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMilliinchPerHour,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.0000254L, 3) / 3600.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMicrometrePerHour,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.000001L, 3) / 3600.0L);
  Internal::TestConversions<VolumeRate, VolumeRate::CubicMicroinchPerHour,
                            VolumeRate::CubicMetrePerSecond>(
      value, value * std::pow(0.0000000254L, 3) / 3600.0L);
}
