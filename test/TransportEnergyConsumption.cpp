...
TEST(TransportEnergyConsumption, AssignmentOperatorAddition) {
  TransportEnergyConsumption quantity{1.0, Unit::TransportEnergyConsumption::JoulePerMetre};
  quantity += TransportEnergyConsumption(2.0, Unit::TransportEnergyConsumption::JoulePerMetre);
  EXPECT_EQ(
      quantity, TransportEnergyConsumption(3.0, Unit::TransportEnergyConsumption::JoulePerMetre));
}

TEST(TransportEnergyConsumption, AssignmentOperatorDivision) {
  TransportEnergyConsumption quantity{8.0, Unit::TransportEnergyConsumption::JoulePerMetre};
  quantity /= 2.0;
  EXPECT_EQ(
      quantity, TransportEnergyConsumption(4.0, Unit::TransportEnergyConsumption::JoulePerMetre));
}

TEST(TransportEnergyConsumption, AssignmentOperatorMultiplication) {
  TransportEnergyConsumption quantity{4.0, Unit::TransportEnergyConsumption::JoulePerMetre};
  quantity *= 2.0;
  EXPECT_EQ(
      quantity, TransportEnergyConsumption(8.0, Unit::TransportEnergyConsumption::JoulePerMetre));
}

TEST(TransportEnergyConsumption, AssignmentOperatorSubtraction) {
  TransportEnergyConsumption quantity{3.0, Unit::TransportEnergyConsumption::JoulePerMetre};
  quantity -= TransportEnergyConsumption(2.0, Unit::TransportEnergyConsumption::JoulePerMetre);
  EXPECT_EQ(
      quantity, TransportEnergyConsumption(1.0, Unit::TransportEnergyConsumption::JoulePerMetre));
}

TEST(TransportEnergyConsumption, ComparisonOperators) {
  const TransportEnergyConsumption first{1.11, Unit::TransportEnergyConsumption::JoulePerMetre};
  const TransportEnergyConsumption second{2.22, Unit::TransportEnergyConsumption::JoulePerMetre};
...
TEST(TransportEnergyConsumption, Create) {
  constexpr TransportEnergyConsumption quantity =
      TransportEnergyConsumption::Create<Unit::TransportEnergyConsumption::JoulePerMetre>(1.11);
  EXPECT_EQ(
      quantity, TransportEnergyConsumption(1.11, Unit::TransportEnergyConsumption::JoulePerMetre));
}
...
TEST(TransportEnergyConsumption, Hash) {
  ...
  const TransportEnergyConsumption third{-1.11, Unit::TransportEnergyConsumption::JoulePerMetre};
...
TEST(TransportEnergyConsumption, JSON) {
  EXPECT_EQ(
      TransportEnergyConsumption(1.11, Unit::TransportEnergyConsumption::JoulePerMetre).JSON(),
      "{\"value\":1.110000000000000,\"unit\":\"J/m\"}");
  EXPECT_EQ(
      TransportEnergyConsumption(-2.22, Unit::TransportEnergyConsumption::KilowattHourPerKilometre)
...
TEST(TransportEnergyConsumption, MoveAssignmentOperator) {
  TransportEnergyConsumption first{1.11, Unit::TransportEnergyConsumption::JoulePerMetre};
  TransportEnergyConsumption second = TransportEnergyConsumption::Zero();
  second = std::move(first);
  EXPECT_EQ(
      second, TransportEnergyConsumption(1.11, Unit::TransportEnergyConsumption::JoulePerMetre));
}
...
TEST(TransportEnergyConsumption, MutableValue) {
  TransportEnergyConsumption quantity{1.11, Unit::TransportEnergyConsumption::JoulePerMetre};
...
TEST(TransportEnergyConsumption, Print) {
  EXPECT_EQ(
      TransportEnergyConsumption(1.11, Unit::TransportEnergyConsumption::JoulePerMetre).Print(),
...
TEST(TransportEnergyConsumption, StandardConstructor) {
  EXPECT_NO_THROW(
      TransportEnergyConsumption(1.11, Unit::TransportEnergyConsumption::KilowattHourPerKilometre));
}

TEST(TransportEnergyConsumption, StaticValue) {
  constexpr TransportEnergyConsumption quantity = TransportEnergyConsumption::Create<
      Unit::TransportEnergyConsumption::KilowattHourPerKilometre>(1.11);
  constexpr double value =
      quantity.StaticValue<Unit::TransportEnergyConsumption::KilowattHourPerKilometre>();
...
TEST(TransportEnergyConsumption, Value) {
  EXPECT_EQ(
      TransportEnergyConsumption(1.11, Unit::TransportEnergyConsumption::JoulePerMetre).Value(),
      1.11);
  EXPECT_EQ(
      TransportEnergyConsumption(1.11, Unit::TransportEnergyConsumption::KilowattHourPerKilometre)
...
TEST(TransportEnergyConsumption, XML) {
  EXPECT_EQ(TransportEnergyConsumption(1.11, Unit::TransportEnergyConsumption::JoulePerMetre).XML(),
...
TEST(TransportEnergyConsumption, YAML) {
  EXPECT_EQ(
      TransportEnergyConsumption(1.11, Unit::TransportEnergyConsumption::JoulePerMetre).YAML(),
      "{value:1.110000000000000,unit:\"J/m\"}");
  EXPECT_EQ(
      TransportEnergyConsumption(-2.22, Unit::TransportEnergyConsumption::KilowattHourPerKilometre)
