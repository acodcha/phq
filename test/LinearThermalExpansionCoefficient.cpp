...
TEST(LinearThermalExpansionCoefficient, AssignmentOperatorAddition) {
  LinearThermalExpansionCoefficient quantity{
      1.0, Unit::ThermalExpansion::PerKelvin};
  quantity +=
      LinearThermalExpansionCoefficient(2.0, Unit::ThermalExpansion::PerKelvin);
  EXPECT_EQ(quantity, LinearThermalExpansionCoefficient(
                          3.0, Unit::ThermalExpansion::PerKelvin));
}
...
TEST(LinearThermalExpansionCoefficient, ComparisonOperators) {
  const LinearThermalExpansionCoefficient first{
      0.1, Unit::ThermalExpansion::PerKelvin};
  const LinearThermalExpansionCoefficient second{
      0.2, Unit::ThermalExpansion::PerKelvin};
...
TEST(LinearThermalExpansionCoefficient, CopyAssignmentOperator) {
  ...
  LinearThermalExpansionCoefficient second =
      LinearThermalExpansionCoefficient::Zero();
  second = first;
...
TEST(LinearThermalExpansionCoefficient, Hash) {
  ...
  const LinearThermalExpansionCoefficient third{
      -1.11, Unit::ThermalExpansion::PerRankine};
...
TEST(LinearThermalExpansionCoefficient, JSON) {
  EXPECT_EQ(
      LinearThermalExpansionCoefficient(1.11, Unit::ThermalExpansion::PerKelvin)
          .JSON(),
      "{\"value\":1.110000000000000,\"unit\":\"/K\"}");
  EXPECT_EQ(LinearThermalExpansionCoefficient(
...
TEST(LinearThermalExpansionCoefficient, MoveAssignmentOperator) {
  ...
  EXPECT_EQ(second, LinearThermalExpansionCoefficient(
                        1.11, Unit::ThermalExpansion::PerKelvin));
}
...
TEST(LinearThermalExpansionCoefficient, MoveConstructor) {
  LinearThermalExpansionCoefficient first{
      1.11, Unit::ThermalExpansion::PerKelvin};
  LinearThermalExpansionCoefficient second{std::move(first)};
  EXPECT_EQ(second, LinearThermalExpansionCoefficient(
                        1.11, Unit::ThermalExpansion::PerKelvin));
}
...
TEST(LinearThermalExpansionCoefficient, Stream) {
  ...
  stream << LinearThermalExpansionCoefficient(
      1.11, Unit::ThermalExpansion::PerKelvin);
  EXPECT_EQ(
      stream.str(),
      LinearThermalExpansionCoefficient(1.11, Unit::ThermalExpansion::PerKelvin)
...
TEST(LinearThermalExpansionCoefficient, Unit) {
  EXPECT_EQ(LinearThermalExpansionCoefficient::Unit(),
