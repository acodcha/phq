...
TEST(ThermalConductivityScalar, ArithmeticOperatorAddition) {
  EXPECT_EQ(ThermalConductivityScalar(
            ...
            ThermalConductivityScalar(
                3.0, Unit::ThermalConductivity::WattPerMetrePerKelvin));
}
...
TEST(ThermalConductivityScalar, AssignmentOperatorAddition) {
  ThermalConductivityScalar quantity{
      1.0, Unit::ThermalConductivity::WattPerMetrePerKelvin};
  quantity += ThermalConductivityScalar(
      2.0, Unit::ThermalConductivity::WattPerMetrePerKelvin);
  EXPECT_EQ(quantity,
            ThermalConductivityScalar(
                3.0, Unit::ThermalConductivity::WattPerMetrePerKelvin));
...
TEST(ThermalConductivityScalar, ComparisonOperators) {
  const ThermalConductivityScalar first{
      0.1, Unit::ThermalConductivity::WattPerMetrePerKelvin};
  const ThermalConductivityScalar second{
      0.2, Unit::ThermalConductivity::WattPerMetrePerKelvin};
...
TEST(ThermalConductivityScalar, CopyAssignmentOperator) {
  const ThermalConductivityScalar first{
      1.11, Unit::ThermalConductivity::WattPerMetrePerKelvin};
...
TEST(ThermalConductivityScalar, Create) {
  constexpr ThermalConductivityScalar quantity =
      ThermalConductivityScalar::Create<
          Unit::ThermalConductivity::WattPerMetrePerKelvin>(1.11);
  EXPECT_EQ(quantity,
            ThermalConductivityScalar(
                1.11, Unit::ThermalConductivity::WattPerMetrePerKelvin));
}
...
TEST(ThermalConductivityScalar, Dimensions) {
  EXPECT_EQ(ThermalConductivityScalar::Dimensions(),
...
TEST(ThermalConductivityScalar, Hash) {
  ...
  const ThermalConductivityScalar third{
      -1.11, Unit::ThermalConductivity::WattPerMetrePerKelvin};
...
TEST(ThermalConductivityScalar, JSON) {
  ...
  EXPECT_EQ(
      ThermalConductivityScalar(
          -2.22, Unit::ThermalConductivity::NanowattPerMillimetrePerKelvin)
...
TEST(ThermalConductivityScalar, MoveAssignmentOperator) {
  ThermalConductivityScalar first{
      1.11, Unit::ThermalConductivity::WattPerMetrePerKelvin};
  ThermalConductivityScalar second = ThermalConductivityScalar::Zero();
  second = std::move(first);
  EXPECT_EQ(
      second, ThermalConductivityScalar(
                  1.11, Unit::ThermalConductivity::WattPerMetrePerKelvin));
}
...
TEST(ThermalConductivityScalar, MoveConstructor) {
  ThermalConductivityScalar first{
      1.11, Unit::ThermalConductivity::WattPerMetrePerKelvin};
  ThermalConductivityScalar second{std::move(first)};
  EXPECT_EQ(
      second, ThermalConductivityScalar(
                  1.11, Unit::ThermalConductivity::WattPerMetrePerKelvin));
}
...
TEST(ThermalConductivityScalar, StandardConstructor) {
  EXPECT_NO_THROW(ThermalConductivityScalar(
      1.11, Unit::ThermalConductivity::NanowattPerMillimetrePerKelvin));
}
...
TEST(ThermalConductivityScalar, Stream) {
  ...
  stream << ThermalConductivityScalar(
      1.11, Unit::ThermalConductivity::WattPerMetrePerKelvin);
...
TEST(ThermalConductivityScalar, Unit) {
  EXPECT_EQ(
      ThermalConductivityScalar::Unit(), Standard<Unit::ThermalConductivity>);
}
...
TEST(ThermalConductivityScalar, Value) {
  ...
  EXPECT_EQ(
      ThermalConductivityScalar(
          2.0, Unit::ThermalConductivity::NanowattPerMillimetrePerKelvin)
...
TEST(ThermalConductivityScalar, Zero) {
  EXPECT_EQ(ThermalConductivityScalar::Zero(),
            ThermalConductivityScalar(
                0.0, Unit::ThermalConductivity::WattPerMetrePerKelvin));
}
