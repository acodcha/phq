...
TEST(ValueDyad, ComparisonOperators) {
  ...
  constexpr Dyad third{1.11, 2.22, 3.33, 4.44, 5.56, 6.66, 7.77, 8.88, 9.990001};
...
TEST(ValueDyad, Hash) {
  constexpr Dyad first{1.11, -2.22, 3.33, -4.44, 5.55, -6.66, 7.77, -8.88, 9.99};
  constexpr Dyad second{1.11, -2.22, 3.33, -4.44, 5.55, -6.66, 7.77, -8.88, 9.990001};
...
TEST(ValueDyad, IsSymmetric) {
  EXPECT_FALSE(Dyad(1.11, -2.22, 3.33, -4.44, 5.55, -6.66, 7.77, -8.88, 9.99).IsSymmetric());
  EXPECT_TRUE(Dyad(1.11, -2.22, 3.33, -2.22, 4.44, -5.55, 3.33, -5.55, 6.66).IsSymmetric());
}

TEST(ValueDyad, JSON) {
  EXPECT_EQ(Dyad(1.0, -2.0, 0.0, 2.0, -4.0, 0.0, 4.0, -8.0, 0.0).JSON(),
            "{\"xx\":1.000000000000000,\"xy\":-2.000000000000000,\"xz\":0,\"yx\":2.000000000000000,"
            "\"yy\":-4.000000000000000,\"yz\":0,\"zx\":4.000000000000000,\"zy\":-8.000000000000000,"
            "\"zz\":0}");
}
...
TEST(ValueDyad, MoveAssignmentOperator) {
  ...
  EXPECT_EQ(second, Dyad(1.11, -2.22, 3.33, -4.44, 5.55, -6.66, 7.77, -8.88, 9.99));
}
...
TEST(ValueDyad, Print) {
  EXPECT_EQ(Dyad(1.0, -2.0, 0.0, 2.0, -4.0, 0.0, 4.0, -8.0, 0.0).Print(),
            "(1.000000000000000, -2.000000000000000, 0; 2.000000000000000, -4.000000000000000, 0; "
            "4.000000000000000, -8.000000000000000, 0)");
  EXPECT_EQ(Dyad(1.0, -2.0, 0.0, 2.0, -4.0, 0.0, 4.0, -8.0, 0.0).Print(Precision::Double),
            "(1.000000000000000, -2.000000000000000, 0; 2.000000000000000, -4.000000000000000, 0; "
            "4.000000000000000, -8.000000000000000, 0)");
  EXPECT_EQ(Dyad(1.0, -2.0, 0.0, 2.0, -4.0, 0.0, 4.0, -8.0, 0.0).Print(Precision::Single),
            "(1.000000, -2.000000, 0; 2.000000, -4.000000, 0; 4.000000, -8.000000, 0)");
}

TEST(ValueDyad, Set) {
  Dyad first(1.11, -2.22, 3.33, -4.44, 5.55, -6.66, 7.77, -8.88, 9.99);
  first.Set_xx_xy_xz_yx_yy_yz_zx_zy_zz(
      std::array<double, 9>{-10.10, 11.11, -12.12, 13.13, -14.14, 15.15, -16.16, 17.17, -18.18});
  EXPECT_EQ(first, Dyad(-10.10, 11.11, -12.12, 13.13, -14.14, 15.15, -16.16, 17.17, -18.18));

  Dyad second(1.11, -2.22, 3.33, -4.44, 5.55, -6.66, 7.77, -8.88, 9.99);
  second.Set_xx_xy_xz_yx_yy_yz_zx_zy_zz(
      -10.10, 11.11, -12.12, 13.13, -14.14, 15.15, -16.16, 17.17, -18.18);
  EXPECT_EQ(second, Dyad(-10.10, 11.11, -12.12, 13.13, -14.14, 15.15, -16.16, 17.17, -18.18));
  ...
  third.Set_zy(17.17);
  third.Set_zz(-18.18);
  EXPECT_EQ(third, Dyad(-10.10, 11.11, -12.12, 13.13, -14.14, 15.15, -16.16, 17.17, -18.18));
}
...
TEST(ValueDyad, StandardConstructor) {
  EXPECT_EQ(Dyad(std::array<double, 9>{1.11, -2.22, 3.33, -4.44, 5.55, -6.66, 7.77, -8.88, 9.99}),
            Dyad(1.11, -2.22, 3.33, -4.44, 5.55, -6.66, 7.77, -8.88, 9.99));

  constexpr std::array<double, 9> first_xx_xy_xz_yx_yy_yz_zx_zy_zz{
...
TEST(ValueDyad, XML) {
  EXPECT_EQ(Dyad(1.0, -2.0, 0.0, 2.0, -4.0, 0.0, 4.0, -8.0, 0.0).XML(),
            "<xx>1.000000000000000</xx><xy>-2.000000000000000</xy><xz>0</xz><yx>2.000000000000000</"
            "yx><yy>-4.000000000000000</yy><yz>0</yz><zx>4.000000000000000</"
            "zx><zy>-8.000000000000000</zy><zz>0</zz>");
}

TEST(ValueDyad, YAML) {
  EXPECT_EQ(Dyad(1.0, -2.0, 0.0, 2.0, -4.0, 0.0, 4.0, -8.0, 0.0).YAML(),
            "{xx:1.000000000000000,xy:-2.000000000000000,xz:0,yx:2.000000000000000,yy:-4."
            "000000000000000,yz:0,zx:4.000000000000000,zy:-8.000000000000000,zz:0}");
}
