...
TEST(TotalKinematicPressure, ArithmeticOperatorDivision) {
  EXPECT_EQ(
      TotalKinematicPressure(8.0, Unit::SpecificEnergy::JoulePerKilogram) / 2.0,
...
TEST(TotalKinematicPressure, ArithmeticOperatorMultiplication) {
  EXPECT_EQ(
      TotalKinematicPressure(4.0, Unit::SpecificEnergy::JoulePerKilogram) * 2.0,
      TotalKinematicPressure(8.0, Unit::SpecificEnergy::JoulePerKilogram));

  EXPECT_EQ(
      2.0 * TotalKinematicPressure(4.0, Unit::SpecificEnergy::JoulePerKilogram),
      TotalKinematicPressure(8.0, Unit::SpecificEnergy::JoulePerKilogram));
}
...
TEST(TotalKinematicPressure, AssignmentOperatorAddition) {
  ...
  quantity +=
      TotalKinematicPressure(2.0, Unit::SpecificEnergy::JoulePerKilogram);
  EXPECT_EQ(quantity, TotalKinematicPressure(
...
TEST(TotalKinematicPressure, ComparisonOperators) {
  const TotalKinematicPressure first{
      1.11, Unit::SpecificEnergy::JoulePerKilogram};
  const TotalKinematicPressure second{
      2.22, Unit::SpecificEnergy::JoulePerKilogram};
...
TEST(TotalKinematicPressure, Create) {
  constexpr TotalKinematicPressure quantity =
      TotalKinematicPressure::Create<Unit::SpecificEnergy::JoulePerKilogram>(
          1.11);
  EXPECT_EQ(quantity, TotalKinematicPressure(
                          1.11, Unit::SpecificEnergy::JoulePerKilogram));
}
...
TEST(TotalKinematicPressure, Dimensions) {
  EXPECT_EQ(TotalKinematicPressure::Dimensions(),
...
TEST(TotalKinematicPressure, Hash) {
  ...
  const TotalKinematicPressure third{
      -1.11, Unit::SpecificEnergy::NanojoulePerGram};
...
TEST(TotalKinematicPressure, JSON) {
  EXPECT_EQ(TotalKinematicPressure(1.11, Unit::SpecificEnergy::JoulePerKilogram)
                .JSON(),
            "{\"value\":1.110000000000000,\"unit\":\"J/kg\"}");
  EXPECT_EQ(
      TotalKinematicPressure(-2.22, Unit::SpecificEnergy::NanojoulePerGram)
...
TEST(TotalKinematicPressure, MoveAssignmentOperator) {
  ...
  EXPECT_EQ(second, TotalKinematicPressure(
                        1.11, Unit::SpecificEnergy::JoulePerKilogram));
}

TEST(TotalKinematicPressure, MoveConstructor) {
  TotalKinematicPressure first{1.11, Unit::SpecificEnergy::JoulePerKilogram};
  TotalKinematicPressure second{std::move(first)};
  EXPECT_EQ(second, TotalKinematicPressure(
                        1.11, Unit::SpecificEnergy::JoulePerKilogram));
}
...
TEST(TotalKinematicPressure, StandardConstructor) {
  EXPECT_NO_THROW(
      TotalKinematicPressure(1.11, Unit::SpecificEnergy::NanojoulePerGram));
}

TEST(TotalKinematicPressure, StaticValue) {
  constexpr TotalKinematicPressure quantity =
      TotalKinematicPressure::Create<Unit::SpecificEnergy::NanojoulePerGram>(
          2.0);
...
TEST(TotalKinematicPressure, Stream) {
  ...
  stream
      << TotalKinematicPressure(1.11, Unit::SpecificEnergy::JoulePerKilogram);
