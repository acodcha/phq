...
TEST(IsobaricHeatCapacity, ArithmeticOperatorMultiplication) {
  ...
  EXPECT_EQ(IsochoricHeatCapacity(4.0, Unit::HeatCapacity::JoulePerKelvin)
                * HeatCapacityRatio(2.0),
            IsobaricHeatCapacity(8.0, Unit::HeatCapacity::JoulePerKelvin));
}
...
TEST(IsobaricHeatCapacity, AssignmentOperatorAddition) {
  ...
  EXPECT_EQ(
      quantity, IsobaricHeatCapacity(3.0, Unit::HeatCapacity::JoulePerKelvin));
}
...
TEST(IsobaricHeatCapacity, AssignmentOperatorDivision) {
  ...
  quantity /= 2.0;
  EXPECT_EQ(
      quantity, IsobaricHeatCapacity(4.0, Unit::HeatCapacity::JoulePerKelvin));
}
...
TEST(IsobaricHeatCapacity, AssignmentOperatorMultiplication) {
  ...
  quantity *= 2.0;
  EXPECT_EQ(
      quantity, IsobaricHeatCapacity(8.0, Unit::HeatCapacity::JoulePerKelvin));
}
...
TEST(IsobaricHeatCapacity, AssignmentOperatorSubtraction) {
  ...
  quantity -= IsobaricHeatCapacity(2.0, Unit::HeatCapacity::JoulePerKelvin);
  EXPECT_EQ(
      quantity, IsobaricHeatCapacity(1.0, Unit::HeatCapacity::JoulePerKelvin));
}
...
TEST(IsobaricHeatCapacity, Create) {
  ...
  EXPECT_EQ(
      quantity, IsobaricHeatCapacity(1.11, Unit::HeatCapacity::JoulePerKelvin));
}
...
TEST(IsobaricHeatCapacity, JSON) {
  EXPECT_EQ(
      IsobaricHeatCapacity(1.11, Unit::HeatCapacity::JoulePerKelvin).JSON(),
...
TEST(IsobaricHeatCapacity, MoveAssignmentOperator) {
  ...
  EXPECT_EQ(
      second, IsobaricHeatCapacity(1.11, Unit::HeatCapacity::JoulePerKelvin));
}

TEST(IsobaricHeatCapacity, MoveConstructor) {
  IsobaricHeatCapacity first{1.11, Unit::HeatCapacity::JoulePerKelvin};
  IsobaricHeatCapacity second{std::move(first)};
  EXPECT_EQ(
      second, IsobaricHeatCapacity(1.11, Unit::HeatCapacity::JoulePerKelvin));
}
...
TEST(IsobaricHeatCapacity, Print) {
  EXPECT_EQ(
      IsobaricHeatCapacity(1.11, Unit::HeatCapacity::JoulePerKelvin).Print(),
...
TEST(IsobaricHeatCapacity, StandardConstructor) {
  EXPECT_NO_THROW(
      IsobaricHeatCapacity(1.11, Unit::HeatCapacity::NanojoulePerKelvin));
}
...
TEST(IsobaricHeatCapacity, Value) {
  EXPECT_EQ(
      IsobaricHeatCapacity(1.11, Unit::HeatCapacity::JoulePerKelvin).Value(),
      1.11);
...
TEST(IsobaricHeatCapacity, XML) {
  EXPECT_EQ(
      IsobaricHeatCapacity(1.11, Unit::HeatCapacity::JoulePerKelvin).XML(),
...
TEST(IsobaricHeatCapacity, YAML) {
  EXPECT_EQ(
      IsobaricHeatCapacity(1.11, Unit::HeatCapacity::JoulePerKelvin).YAML(),
      "{value:1.110000000000000,unit:\"J/K\"}");
  EXPECT_EQ(IsobaricHeatCapacity(-2.22, Unit::HeatCapacity::NanojoulePerKelvin)
