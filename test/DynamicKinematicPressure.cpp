...
TEST(DynamicKinematicPressure, AssignmentOperatorAddition) {
  DynamicKinematicPressure quantity{
      1.0, Unit::SpecificEnergy::JoulePerKilogram};
  quantity +=
      DynamicKinematicPressure(2.0, Unit::SpecificEnergy::JoulePerKilogram);
  EXPECT_EQ(quantity, DynamicKinematicPressure(
...
TEST(DynamicKinematicPressure, ComparisonOperators) {
  const DynamicKinematicPressure first{
      1.11, Unit::SpecificEnergy::JoulePerKilogram};
  const DynamicKinematicPressure second{
...
TEST(DynamicKinematicPressure, Create) {
  constexpr DynamicKinematicPressure quantity =
      DynamicKinematicPressure::Create<Unit::SpecificEnergy::JoulePerKilogram>(
          1.11);
  EXPECT_EQ(quantity, DynamicKinematicPressure(
                          1.11, Unit::SpecificEnergy::JoulePerKilogram));
}
...
TEST(DynamicKinematicPressure, Dimensions) {
  EXPECT_EQ(DynamicKinematicPressure::Dimensions(),
...
TEST(DynamicKinematicPressure, Hash) {
  ...
  const DynamicKinematicPressure third{
      -1.11, Unit::SpecificEnergy::NanojoulePerGram};
...
TEST(DynamicKinematicPressure, JSON) {
  EXPECT_EQ(
      DynamicKinematicPressure(1.11, Unit::SpecificEnergy::JoulePerKilogram)
          .JSON(),
      "{\"value\":1.110000000000000,\"unit\":\"J/kg\"}");
  EXPECT_EQ(
      DynamicKinematicPressure(-2.22, Unit::SpecificEnergy::NanojoulePerGram)
...
TEST(DynamicKinematicPressure, MiscellaneousConstructors) {
  EXPECT_EQ(
      DynamicKinematicPressure(Speed(4.0, Unit::Speed::MetrePerSecond)),
      DynamicKinematicPressure(8.0, Unit::SpecificEnergy::JoulePerKilogram));
  ...
  EXPECT_EQ(Speed(DynamicKinematicPressure(
                8.0, Unit::SpecificEnergy::JoulePerKilogram)),
...
TEST(DynamicKinematicPressure, MoveAssignmentOperator) {
  ...
  EXPECT_EQ(second, DynamicKinematicPressure(
                        1.11, Unit::SpecificEnergy::JoulePerKilogram));
}

TEST(DynamicKinematicPressure, MoveConstructor) {
  DynamicKinematicPressure first{1.11, Unit::SpecificEnergy::JoulePerKilogram};
  DynamicKinematicPressure second{std::move(first)};
  EXPECT_EQ(second, DynamicKinematicPressure(
                        1.11, Unit::SpecificEnergy::JoulePerKilogram));
}
...
TEST(DynamicKinematicPressure, StandardConstructor) {
  EXPECT_NO_THROW(
      DynamicKinematicPressure(1.11, Unit::SpecificEnergy::NanojoulePerGram));
}

TEST(DynamicKinematicPressure, StaticValue) {
  constexpr DynamicKinematicPressure quantity =
      DynamicKinematicPressure::Create<Unit::SpecificEnergy::NanojoulePerGram>(
          2.0);
...
TEST(DynamicKinematicPressure, Value) {
  EXPECT_EQ(
      ...
      1.11);
  EXPECT_EQ(
      DynamicKinematicPressure(2.0, Unit::SpecificEnergy::NanojoulePerGram)
