...
TEST(IsentropicBulkModulus, Dimensions) {
  EXPECT_EQ(
      IsentropicBulkModulus::Dimensions(), RelatedDimensions<Unit::Pressure>);
}
...
TEST(IsentropicBulkModulus, JSON) {
  ...
  EXPECT_EQ(IsentropicBulkModulus(-2.22, Unit::Pressure::Kilopascal)
...
TEST(IsentropicBulkModulus, MoveConstructor) {
  IsentropicBulkModulus first{1.11, Unit::Pressure::Pascal};
  IsentropicBulkModulus second{std::move(first)};
  EXPECT_EQ(second, IsentropicBulkModulus(1.11, Unit::Pressure::Pascal));
}
...
TEST(IsentropicBulkModulus, Print) {
  EXPECT_EQ(IsentropicBulkModulus(1.11, Unit::Pressure::Pascal).Print(),
...
TEST(IsentropicBulkModulus, Stream) {
  ...
  EXPECT_EQ(stream.str(),
            IsentropicBulkModulus(1.11, Unit::Pressure::Pascal).Print());
}
...
TEST(IsentropicBulkModulus, Value) {
  ...
  EXPECT_EQ(IsentropicBulkModulus(2.0, Unit::Pressure::Kilopascal)
...
TEST(IsentropicBulkModulus, Zero) {
  EXPECT_EQ(IsentropicBulkModulus::Zero(),
            IsentropicBulkModulus(0.0, Unit::Pressure::Pascal));
}
