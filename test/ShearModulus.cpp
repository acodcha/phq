...
TEST(ShearModulus, Create) {
  constexpr ShearModulus quantity = ShearModulus::Create<Unit::Pressure::Pascal>(1.11);
...
TEST(ShearModulus, JSON) {
  ...
  EXPECT_EQ(ShearModulus(-2.22, Unit::Pressure::Kilopascal).JSON(Unit::Pressure::Kilopascal),
...
TEST(ShearModulus, Print) {
  EXPECT_EQ(ShearModulus(1.11, Unit::Pressure::Pascal).Print(), "1.110000000000000 Pa");
  EXPECT_EQ(ShearModulus(-2.22, Unit::Pressure::Kilopascal).Print(Unit::Pressure::Kilopascal),
...
TEST(ShearModulus, StaticValue) {
  constexpr ShearModulus quantity = ShearModulus::Create<Unit::Pressure::Kilopascal>(1.11);
...
TEST(ShearModulus, Value) {
  ...
  EXPECT_EQ(ShearModulus(1.11, Unit::Pressure::Kilopascal).Value(Unit::Pressure::Kilopascal), 1.11);
}

TEST(ShearModulus, XML) {
  EXPECT_EQ(ShearModulus(1.11, Unit::Pressure::Pascal).XML(),
            "<value>1.110000000000000</value><unit>Pa</unit>");
  EXPECT_EQ(ShearModulus(-2.22, Unit::Pressure::Kilopascal).XML(Unit::Pressure::Kilopascal),
            "<value>-2.220000000000000</value><unit>kPa</unit>");
}

TEST(ShearModulus, YAML) {
  EXPECT_EQ(
      ShearModulus(1.11, Unit::Pressure::Pascal).YAML(), "{value:1.110000000000000,unit:\"Pa\"}");
  EXPECT_EQ(ShearModulus(-2.22, Unit::Pressure::Kilopascal).YAML(Unit::Pressure::Kilopascal),
            "{value:-2.220000000000000,unit:\"kPa\"}");
}
