...
TEST(ThermalDiffusivity, ArithmeticOperatorDivision) {
  EXPECT_EQ(
      ThermalDiffusivity(8.0, Unit::Diffusivity::SquareMetrePerSecond) / 2.0,
...
TEST(ThermalDiffusivity, ArithmeticOperatorMultiplication) {
  EXPECT_EQ(
      ThermalDiffusivity(4.0, Unit::Diffusivity::SquareMetrePerSecond) * 2.0,
      ThermalDiffusivity(8.0, Unit::Diffusivity::SquareMetrePerSecond));

  EXPECT_EQ(
      2.0 * ThermalDiffusivity(4.0, Unit::Diffusivity::SquareMetrePerSecond),
      ThermalDiffusivity(8.0, Unit::Diffusivity::SquareMetrePerSecond));
}
...
TEST(ThermalDiffusivity, Create) {
  ...
  EXPECT_EQ(quantity,
            ThermalDiffusivity(1.11, Unit::Diffusivity::SquareMetrePerSecond));
}
...
TEST(ThermalDiffusivity, Dimensions) {
  EXPECT_EQ(
      ThermalDiffusivity::Dimensions(), RelatedDimensions<Unit::Diffusivity>);
}

TEST(ThermalDiffusivity, Hash) {
  const ThermalDiffusivity first{1.11, Unit::Diffusivity::SquareMetrePerSecond};
  const ThermalDiffusivity second{
      1.110001, Unit::Diffusivity::SquareMetrePerSecond};
  const ThermalDiffusivity third{
...
TEST(ThermalDiffusivity, JSON) {
  EXPECT_EQ(
      ThermalDiffusivity(1.11, Unit::Diffusivity::SquareMetrePerSecond).JSON(),
      "{\"value\":1.110000000000000,\"unit\":\"m^2/s\"}");
  EXPECT_EQ(
      ThermalDiffusivity(-2.22, Unit::Diffusivity::SquareMillimetrePerSecond)
...
TEST(ThermalDiffusivity, MiscellaneousConstructors) {
  EXPECT_EQ(
      ThermalDiffusivity(
          ThermalConductivityScalar(
              8.0, Unit::ThermalConductivity::WattPerMetrePerKelvin),
  ...
  EXPECT_EQ(
      ThermalConductivityScalar(
          ...
          ThermalDiffusivity(8.0, Unit::Diffusivity::SquareMetrePerSecond)),
      ThermalConductivityScalar(
          64.0, Unit::ThermalConductivity::WattPerMetrePerKelvin));
...
TEST(ThermalDiffusivity, MoveConstructor) {
  ThermalDiffusivity first{1.11, Unit::Diffusivity::SquareMetrePerSecond};
  ThermalDiffusivity second{std::move(first)};
  EXPECT_EQ(second,
            ThermalDiffusivity(1.11, Unit::Diffusivity::SquareMetrePerSecond));
}
...
TEST(ThermalDiffusivity, Print) {
  EXPECT_EQ(
      ThermalDiffusivity(1.11, Unit::Diffusivity::SquareMetrePerSecond).Print(),
...
TEST(ThermalDiffusivity, StandardConstructor) {
  EXPECT_NO_THROW(
      ThermalDiffusivity(1.11, Unit::Diffusivity::SquareMillimetrePerSecond));
}

TEST(ThermalDiffusivity, StaticValue) {
  constexpr ThermalDiffusivity quantity =
      ThermalDiffusivity::Create<Unit::Diffusivity::SquareMillimetrePerSecond>(
          2.0);
  constexpr double value =
      quantity.StaticValue<Unit::Diffusivity::SquareMillimetrePerSecond>();
  EXPECT_EQ(value, 2.0);
}
...
TEST(ThermalDiffusivity, Value) {
  EXPECT_EQ(
      ThermalDiffusivity(1.11, Unit::Diffusivity::SquareMetrePerSecond).Value(),
      1.11);
  EXPECT_EQ(
      ThermalDiffusivity(2.0, Unit::Diffusivity::SquareMillimetrePerSecond)
...
TEST(ThermalDiffusivity, XML) {
  EXPECT_EQ(
      ThermalDiffusivity(1.11, Unit::Diffusivity::SquareMetrePerSecond).XML(),
...
TEST(ThermalDiffusivity, YAML) {
  EXPECT_EQ(
      ThermalDiffusivity(1.11, Unit::Diffusivity::SquareMetrePerSecond).YAML(),
      "{value:1.110000000000000,unit:\"m^2/s\"}");
  EXPECT_EQ(
      ThermalDiffusivity(-2.22, Unit::Diffusivity::SquareMillimetrePerSecond)
