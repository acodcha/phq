...
TEST(SpecificPower, Create) {
  ...
  EXPECT_EQ(quantity, SpecificPower(1.11, Unit::SpecificPower::WattPerKilogram));
}
...
TEST(SpecificPower, Print) {
  EXPECT_EQ(
      SpecificPower(1.11, Unit::SpecificPower::WattPerKilogram).Print(), "1.110000000000000 W/kg");
  EXPECT_EQ(SpecificPower(-2.22, Unit::SpecificPower::NanowattPerGram)
...
TEST(SpecificPower, Stream) {
  ...
  EXPECT_EQ(stream.str(), SpecificPower(1.11, Unit::SpecificPower::WattPerKilogram).Print());
}
...
TEST(SpecificPower, Value) {
  EXPECT_EQ(SpecificPower(1.11, Unit::SpecificPower::WattPerKilogram).Value(), 1.11);
