...
TEST(SpecificPower, ArithmeticOperatorDivision) {
  ...
  EXPECT_EQ(Power(8.0, Unit::Power::Watt)
                / SpecificPower(4.0, Unit::SpecificPower::WattPerKilogram),
...
TEST(SpecificPower, ArithmeticOperatorMultiplication) {
  ...
  EXPECT_EQ(SpecificPower(4.0, Unit::SpecificPower::WattPerKilogram)
                * Time(2.0, Unit::Time::Second),
...
TEST(SpecificPower, ComparisonOperators) {
  const SpecificPower first{1.11, Unit::SpecificPower::WattPerKilogram};
  const SpecificPower second{2.22, Unit::SpecificPower::WattPerKilogram};
...
TEST(SpecificPower, Create) {
  constexpr SpecificPower quantity =
      SpecificPower::Create<Unit::SpecificPower::WattPerKilogram>(1.11);
  EXPECT_EQ(
      quantity, SpecificPower(1.11, Unit::SpecificPower::WattPerKilogram));
}
...
TEST(SpecificPower, Dimensions) {
  EXPECT_EQ(
      SpecificPower::Dimensions(), RelatedDimensions<Unit::SpecificPower>);
}

TEST(SpecificPower, Hash) {
  const SpecificPower first{1.11, Unit::SpecificPower::NanowattPerGram};
  const SpecificPower second{1.110001, Unit::SpecificPower::NanowattPerGram};
  const SpecificPower third{-1.11, Unit::SpecificPower::NanowattPerGram};
...
TEST(SpecificPower, JSON) {
  EXPECT_EQ(SpecificPower(1.11, Unit::SpecificPower::WattPerKilogram).JSON(),
            "{\"value\":1.110000000000000,\"unit\":\"W/kg\"}");
  EXPECT_EQ(SpecificPower(-2.22, Unit::SpecificPower::NanowattPerGram)
                .JSON(Unit::SpecificPower::NanowattPerGram),
            "{\"value\":-2.220000000000000,\"unit\":\"nW/g\"}");
}

TEST(SpecificPower, MiscellaneousConstructors) {
  EXPECT_EQ(
      SpecificPower(SpecificEnergy(8.0, Unit::SpecificEnergy::JoulePerKilogram),
                    Time(4.0, Unit::Time::Second)),
      SpecificPower(2.0, Unit::SpecificPower::WattPerKilogram));

  EXPECT_EQ(
      SpecificPower(SpecificEnergy(4.0, Unit::SpecificEnergy::JoulePerKilogram),
                    Frequency(2.0, Unit::Frequency::Hertz)),
      SpecificPower(8.0, Unit::SpecificPower::WattPerKilogram));

  EXPECT_EQ(SpecificPower(
                Power(8.0, Unit::Power::Watt), Mass(4.0, Unit::Mass::Kilogram)),
            SpecificPower(2.0, Unit::SpecificPower::WattPerKilogram));
  ...
  EXPECT_EQ(
      Frequency(SpecificPower(8.0, Unit::SpecificPower::WattPerKilogram),
                SpecificEnergy(4.0, Unit::SpecificEnergy::JoulePerKilogram)),
      Frequency(2.0, Unit::Frequency::Hertz));

  EXPECT_EQ(Mass(Power(8.0, Unit::Power::Watt),
                 SpecificPower(4.0, Unit::SpecificPower::WattPerKilogram)),
            Mass(2.0, Unit::Mass::Kilogram));
  ...
  EXPECT_EQ(
      SpecificEnergy(SpecificPower(4.0, Unit::SpecificPower::WattPerKilogram),
                     Time(2.0, Unit::Time::Second)),
      SpecificEnergy(8.0, Unit::SpecificEnergy::JoulePerKilogram));

  EXPECT_EQ(
      SpecificEnergy(SpecificPower(8.0, Unit::SpecificPower::WattPerKilogram),
                     Frequency(2.0, Unit::Frequency::Hertz)),
      SpecificEnergy(4.0, Unit::SpecificEnergy::JoulePerKilogram));
}

TEST(SpecificPower, MoveAssignmentOperator) {
  SpecificPower first{1.11, Unit::SpecificPower::WattPerKilogram};
  SpecificPower second = SpecificPower::Zero();
  second = std::move(first);
  EXPECT_EQ(second, SpecificPower(1.11, Unit::SpecificPower::WattPerKilogram));
}

TEST(SpecificPower, MoveConstructor) {
  SpecificPower first{1.11, Unit::SpecificPower::WattPerKilogram};
  SpecificPower second{std::move(first)};
  EXPECT_EQ(second, SpecificPower(1.11, Unit::SpecificPower::WattPerKilogram));
}

TEST(SpecificPower, MutableValue) {
  SpecificPower quantity{1.11, Unit::SpecificPower::WattPerKilogram};
...
TEST(SpecificPower, Print) {
  EXPECT_EQ(SpecificPower(1.11, Unit::SpecificPower::WattPerKilogram).Print(),
            "1.110000000000000 W/kg");
  EXPECT_EQ(SpecificPower(-2.22, Unit::SpecificPower::NanowattPerGram)
                .Print(Unit::SpecificPower::NanowattPerGram),
            "-2.220000000000000 nW/g");
}
...
TEST(SpecificPower, StandardConstructor) {
  EXPECT_NO_THROW(SpecificPower(1.11, Unit::SpecificPower::NanowattPerGram));
}
...
TEST(SpecificPower, StaticValue) {
  ...
  constexpr double value =
      quantity.StaticValue<Unit::SpecificPower::NanowattPerGram>();
  EXPECT_EQ(value, 2.0);
}

TEST(SpecificPower, Stream) {
  std::ostringstream stream;
  stream << SpecificPower(1.11, Unit::SpecificPower::WattPerKilogram);
  EXPECT_EQ(stream.str(),
            SpecificPower(1.11, Unit::SpecificPower::WattPerKilogram).Print());
}
...
TEST(SpecificPower, Value) {
  EXPECT_EQ(
      SpecificPower(1.11, Unit::SpecificPower::WattPerKilogram).Value(), 1.11);
...
TEST(SpecificPower, XML) {
  EXPECT_EQ(SpecificPower(1.11, Unit::SpecificPower::WattPerKilogram).XML(),
            "<value>1.110000000000000</value><unit>W/kg</unit>");
  EXPECT_EQ(SpecificPower(-2.22, Unit::SpecificPower::NanowattPerGram)
                .XML(Unit::SpecificPower::NanowattPerGram),
            "<value>-2.220000000000000</value><unit>nW/g</unit>");
}

TEST(SpecificPower, YAML) {
  EXPECT_EQ(SpecificPower(1.11, Unit::SpecificPower::WattPerKilogram).YAML(),
            "{value:1.110000000000000,unit:\"W/kg\"}");
  EXPECT_EQ(SpecificPower(-2.22, Unit::SpecificPower::NanowattPerGram)
...
TEST(SpecificPower, Zero) {
  EXPECT_EQ(SpecificPower::Zero(),
            SpecificPower(0.0, Unit::SpecificPower::WattPerKilogram));
}
