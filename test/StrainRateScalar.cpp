...
TEST(StrainRateScalar, ArithmeticOperatorAddition) {
  EXPECT_EQ(StrainRateScalar(1.0, Unit::Frequency::Hertz)
...
TEST(StrainRateScalar, ArithmeticOperatorDivision) {
  ...
  EXPECT_EQ(StrainRateScalar(8.0, Unit::Frequency::Hertz)
                / StrainRateScalar(2.0, Unit::Frequency::Hertz),
            4.0);
...
TEST(StrainRateScalar, ArithmeticOperatorMultiplication) {
  ...
  EXPECT_EQ(StrainRateScalar(4.0, Unit::Frequency::Hertz)
...
TEST(StrainRateScalar, ArithmeticOperatorSubtraction) {
  EXPECT_EQ(StrainRateScalar(3.0, Unit::Frequency::Hertz)
                - StrainRateScalar(2.0, Unit::Frequency::Hertz),
...
TEST(StrainRateScalar, Create) {
  constexpr StrainRateScalar quantity =
      StrainRateScalar::Create<Unit::Frequency::Hertz>(1.11);
...
TEST(StrainRateScalar, JSON) {
  ...
  EXPECT_EQ(StrainRateScalar(-2.22, Unit::Frequency::Kilohertz)
...
TEST(StrainRateScalar, MiscellaneousConstructors) {
  ...
  EXPECT_EQ(StrainRateScalar(
                StrainScalar(4.0), Frequency(2.0, Unit::Frequency::Hertz)),
            StrainRateScalar(8.0, Unit::Frequency::Hertz));

  EXPECT_EQ(StrainScalar(StrainRateScalar(4.0, Unit::Frequency::Hertz),
                         Time(2.0, Unit::Time::Second)),
            StrainScalar(8.0));
...
TEST(StrainRateScalar, MoveConstructor) {
  StrainRateScalar first{1.11, Unit::Frequency::Hertz};
  StrainRateScalar second{std::move(first)};
  EXPECT_EQ(second, StrainRateScalar(1.11, Unit::Frequency::Hertz));
}
...
TEST(StrainRateScalar, Print) {
  EXPECT_EQ(StrainRateScalar(1.11, Unit::Frequency::Hertz).Print(),
            "1.110000000000000 Hz");
  EXPECT_EQ(StrainRateScalar(-2.22, Unit::Frequency::Kilohertz)
...
TEST(StrainRateScalar, StaticValue) {
  constexpr StrainRateScalar quantity =
      StrainRateScalar::Create<Unit::Frequency::Kilohertz>(1.11);
...
TEST(StrainRateScalar, Stream) {
  ...
  EXPECT_EQ(
      stream.str(), StrainRateScalar(1.11, Unit::Frequency::Hertz).Print());
}
...
TEST(StrainRateScalar, Value) {
  ...
  EXPECT_EQ(StrainRateScalar(1.11, Unit::Frequency::Kilohertz)
...
TEST(StrainRateScalar, Zero) {
  EXPECT_EQ(
      StrainRateScalar::Zero(), StrainRateScalar(0.0, Unit::Frequency::Hertz));
}
