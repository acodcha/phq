...
template <size_t size> const std::map<Unit::SpecificHeatCapacity, std::map<Unit::SpecificHeatCapacity, std::function<void(std::array<double, size>&)>>> conversions<Unit::SpecificHeatCapacity, size>{
