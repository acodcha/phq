...
template <size_t size> const std::map<Unit::SpecificPower, std::map<Unit::SpecificPower, std::function<void(std::array<double, size>&)>>> conversions<Unit::SpecificPower, size>{
