...
template <size_t size> const std::map<Unit::AngularSpeed, std::map<Unit::AngularSpeed, std::function<void(std::array<double, size>&)>>> conversions<Unit::AngularSpeed, size>{
  {Unit::AngularSpeed::RadianPerSecond, {
    ...
    {Unit::AngularSpeed::RevolutionPerSecond, [](std::array<double, size>& values)->void{std::for_each(values.begin(), values.end(), [](double& value)->void{value /= 2.0 * M_PI;});}},
  ...
  {Unit::AngularSpeed::RadianPerMinute, {
    ...
    {Unit::AngularSpeed::RevolutionPerMinute, [](std::array<double, size>& values)->void{std::for_each(values.begin(), values.end(), [](double& value)->void{value /= 2.0 * M_PI;});}},
  ...
  {Unit::AngularSpeed::RadianPerHour, {
    ...
    {Unit::AngularSpeed::DegreePerSecond, [](std::array<double, size>& values)->void{std::for_each(values.begin(), values.end(), [](double& value)->void{value /= 20.0 * M_PI;});}},
    ...
    {Unit::AngularSpeed::RevolutionPerHour, [](std::array<double, size>& values)->void{std::for_each(values.begin(), values.end(), [](double& value)->void{value /= 2.0 * M_PI;});}}}},
  {Unit::AngularSpeed::DegreePerSecond, {
    ...
    {Unit::AngularSpeed::RadianPerHour, [](std::array<double, size>& values)->void{std::for_each(values.begin(), values.end(), [](double& value)->void{value *= M_PI * 20.0;});}},
  ...
  {Unit::AngularSpeed::RevolutionPerMinute, {
    ...
    {Unit::AngularSpeed::RadianPerMinute, [](std::array<double, size>& values)->void{std::for_each(values.begin(), values.end(), [](double& value)->void{value *= M_PI * 2.0;});}},
    {Unit::AngularSpeed::RadianPerHour, [](std::array<double, size>& values)->void{std::for_each(values.begin(), values.end(), [](double& value)->void{value *= M_PI * 120.0;});}},
  ...
  {Unit::AngularSpeed::RevolutionPerHour, {
    ...
    {Unit::AngularSpeed::RadianPerHour, [](std::array<double, size>& values)->void{std::for_each(values.begin(), values.end(), [](double& value)->void{value *= M_PI * 2.0;});}},
