...
inline std::ostream& operator<<(
    std::ostream& stream, const Unit::SpecificPower unit) {
...
template <>
inline const std::map<UnitSystem, Unit::SpecificPower>
...
template <>
inline const std::map<Unit::SpecificPower, UnitSystem>
...
template <>
inline const std::map<Unit::SpecificPower, std::string_view>
...
template <>
inline const std::unordered_map<std::string_view, Unit::SpecificPower>
    Spellings<Unit::SpecificPower>{
