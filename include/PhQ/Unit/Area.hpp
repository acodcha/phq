...
ConversionFromStandard<Unit::Area, Unit::Area::SquareMile>(double& value) noexcept {
  value /= 1609.344 * 1609.344;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Area, Unit::Area::SquareKilometre>(double& value) noexcept {
  value *= 0.000001;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Area, Unit::Area::Hectare>(double& value) noexcept {
  value *= 0.0001;
}
...
template <>
inline constexpr void
ConversionFromStandard<Unit::Area, Unit::Area::SquareYard>(double& value) noexcept {
  value /= 0.9144 * 0.9144;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Area, Unit::Area::SquareFoot>(double& value) noexcept {
  value /= 0.3048 * 0.3048;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Area, Unit::Area::SquareDecimetre>(double& value) noexcept {
  value *= 100.0;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Area, Unit::Area::SquareInch>(double& value) noexcept {
  value /= 0.0254 * 0.0254;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Area, Unit::Area::SquareCentimetre>(double& value) noexcept {
  value *= 10000.0;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Area, Unit::Area::SquareMillimetre>(double& value) noexcept {
  value *= 1000000.0;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Area, Unit::Area::SquareMilliinch>(double& value) noexcept {
  value /= 0.0000254 * 0.0000254;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Area, Unit::Area::SquareMicrometre>(double& value) noexcept {
  value *= 1000000000000.0;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Area, Unit::Area::SquareMicroinch>(double& value) noexcept {
  value /= 0.0000000254 * 0.0000000254;
}

template <>
inline constexpr void
ConversionToStandard<Unit::Area, Unit::Area::SquareMile>(double& value) noexcept {
  value *= 1609.344 * 1609.344;
}

template <>
inline constexpr void
ConversionToStandard<Unit::Area, Unit::Area::SquareKilometre>(double& value) noexcept {
  value *= 1000000.0;
}
...
template <>
inline constexpr void
ConversionToStandard<Unit::Area, Unit::Area::SquareYard>(double& value) noexcept {
  value *= 0.9144 * 0.9144;
}

template <>
inline constexpr void
ConversionToStandard<Unit::Area, Unit::Area::SquareFoot>(double& value) noexcept {
  value *= 0.3048 * 0.3048;
}

template <>
inline constexpr void
ConversionToStandard<Unit::Area, Unit::Area::SquareDecimetre>(double& value) noexcept {
  value *= 0.01;
}

template <>
inline constexpr void
ConversionToStandard<Unit::Area, Unit::Area::SquareInch>(double& value) noexcept {
  value *= 0.0254 * 0.0254;
}

template <>
inline constexpr void
ConversionToStandard<Unit::Area, Unit::Area::SquareCentimetre>(double& value) noexcept {
  value *= 0.0001;
}

template <>
inline constexpr void
ConversionToStandard<Unit::Area, Unit::Area::SquareMillimetre>(double& value) noexcept {
  value *= 0.000001;
}

template <>
inline constexpr void
ConversionToStandard<Unit::Area, Unit::Area::SquareMilliinch>(double& value) noexcept {
  value *= 0.0000254 * 0.0000254;
}

template <>
inline constexpr void
ConversionToStandard<Unit::Area, Unit::Area::SquareMicrometre>(double& value) noexcept {
  value *= 0.000000000001;
}

template <>
inline constexpr void
ConversionToStandard<Unit::Area, Unit::Area::SquareMicroinch>(double& value) noexcept {
  value *= 0.0000000254 * 0.0000000254;
}
