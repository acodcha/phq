...
ConversionFromStandard<Unit::MassRate, Unit::MassRate::KilogramPerSecond>(double&) noexcept {}
...
template <>
inline constexpr void
ConversionToStandard<Unit::MassRate, Unit::MassRate::KilogramPerSecond>(double&) noexcept {}
