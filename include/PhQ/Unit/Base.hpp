...
template <typename Unit> constexpr const Unit StandardUnit;

template <typename Unit> constexpr const Dimension::Set Dimensions;

template <typename Unit> const std::map<Unit, std::map<Unit, std::function<void(std::vector<double>&)>>> Conversions;

template <typename Unit> double convert(const double value, const Unit old_unit, const Unit new_unit) noexcept {
...
template <typename Unit> double convert(const double value, const Unit old_unit, const UnitSystem new_unit_system) noexcept {
  return convert<Unit>(value, old_unit, unit<Unit>(new_unit_system));
}

template <typename Unit> std::vector<double> convert(const std::vector<double>& values, const Unit old_unit, const Unit new_unit) noexcept {
  if (old_unit != new_unit) {
...
template <typename Unit> std::vector<double> convert(const std::vector<double>& values, const Unit old_unit, const UnitSystem new_unit_system) noexcept {
  return convert<Unit>(values, old_unit, unit<Unit>(new_unit_system));
}

template <typename Unit> Value::Vector convert(const Value::Vector& values, const Unit old_unit, const Unit new_unit) noexcept {
...
template <typename Unit> Value::Vector convert(const Value::Vector& values, const Unit old_unit, const UnitSystem new_unit_system) noexcept {
  return convert(values, old_unit, unit<Unit>(new_unit_system));
}

template <typename Unit> Value::SymmetricDyadic convert(const Value::SymmetricDyadic& values, const Unit old_unit, const Unit new_unit) noexcept {
...
template <typename Unit> Value::SymmetricDyadic convert(const Value::SymmetricDyadic& values, const Unit old_unit, const UnitSystem new_unit_system) noexcept {
  return convert(values, old_unit, unit<Unit>(new_unit_system));
}

template <typename Unit> Value::Dyadic convert(const Value::Dyadic& values, const Unit old_unit, const Unit new_unit) noexcept {
...
template <typename Unit> Value::Dyadic convert(const Value::Dyadic& values, const Unit old_unit, const UnitSystem new_unit_system) noexcept {
  return convert(values, old_unit, unit<Unit>(new_unit_system));
}
