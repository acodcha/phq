...
ConversionFromStandard<Unit::Length, Unit::Length::Mile>(double& value) noexcept {
  value /= 1609.344;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Length, Unit::Length::Kilometre>(double& value) noexcept {
  value *= 0.001;
}
...
template <>
inline constexpr void
ConversionFromStandard<Unit::Length, Unit::Length::Yard>(double& value) noexcept {
  value /= 0.9144;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Length, Unit::Length::Foot>(double& value) noexcept {
  value /= 0.3048;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Length, Unit::Length::Decimetre>(double& value) noexcept {
  value *= 10.0;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Length, Unit::Length::Inch>(double& value) noexcept {
  value /= 0.0254;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Length, Unit::Length::Centimetre>(double& value) noexcept {
  value *= 100.0;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Length, Unit::Length::Millimetre>(double& value) noexcept {
  value *= 1000.0;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Length, Unit::Length::Milliinch>(double& value) noexcept {
  value /= 0.0000254;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Length, Unit::Length::Micrometre>(double& value) noexcept {
  value *= 1000000.0;
}

template <>
inline constexpr void
ConversionFromStandard<Unit::Length, Unit::Length::Microinch>(double& value) noexcept {
  value /= 0.0000000254;
}
...
template <>
inline constexpr void
ConversionToStandard<Unit::Length, Unit::Length::Kilometre>(double& value) noexcept {
  value *= 1000.0;
}
...
template <>
inline constexpr void
ConversionToStandard<Unit::Length, Unit::Length::Decimetre>(double& value) noexcept {
  value *= 0.1;
}
...
template <>
inline constexpr void
ConversionToStandard<Unit::Length, Unit::Length::Centimetre>(double& value) noexcept {
  value *= 0.01;
}

template <>
inline constexpr void
ConversionToStandard<Unit::Length, Unit::Length::Millimetre>(double& value) noexcept {
  value *= 0.001;
}

template <>
inline constexpr void
ConversionToStandard<Unit::Length, Unit::Length::Milliinch>(double& value) noexcept {
  value *= 0.0000254;
}

template <>
inline constexpr void
ConversionToStandard<Unit::Length, Unit::Length::Micrometre>(double& value) noexcept {
  value *= 0.000001;
}

template <>
inline constexpr void
ConversionToStandard<Unit::Length, Unit::Length::Microinch>(double& value) noexcept {
  value *= 0.0000000254;
}
