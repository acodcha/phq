...
// Three-dimensional vector value in Cartesian coordinates. Contains three components: x, y, and z.
class Vector {
public:
  // Default constructor. Constructs a three-dimensional vector value with uninitialized x, y, and z
  // Cartesian components.
  Vector() = default;

  // Constructor. Constructs a three-dimensional vector value from the given x, y, and z Cartesian
  // components.
  constexpr Vector(const double x, const double y, const double z) : x_y_z_({x, y, z}) {}

  // Constructor. Constructs a three-dimensional vector value from a given array representing its x,
  // y, and z Cartesian components.
  explicit constexpr Vector(const std::array<double, 3>& x_y_z) : x_y_z_(x_y_z) {}

  // Constructor. Constructs a three-dimensional vector value given a magnitude and a direction.
  constexpr Vector(double magnitude, const Direction& direction);

  // Destructor. Destroys this three-dimensional vector value.
  ~Vector() noexcept = default;

  // Copy constructor. Constructs a three-dimensional vector value by copying another one.
  constexpr Vector(const Vector& other) = default;

  // Move constructor. Constructs a three-dimensional vector value by moving another one.
  constexpr Vector(Vector&& other) noexcept = default;

  // Copy assignment operator. Assigns this three-dimensional vector value by copying another one.
  constexpr Vector& operator=(const Vector& other) = default;

  // Move assignment operator. Assigns this three-dimensional vector value by moving another one.
  constexpr Vector& operator=(Vector&& other) noexcept = default;

  // Assignment operator. Assigns this three-dimensional vector value by copying a given array
  ...
  // Statically creates a three-dimensional vector value with its x, y, and z Cartesian components
  // initialized to zero.
  ...
  // Returns this three-dimensional vector value's x, y, and z Cartesian components as an array.
  ...
  // Returns this three-dimensional vector value's x, y, and z Cartesian components as a mutable
  // array.
  constexpr std::array<double, 3>& Mutable_x_y_z() noexcept {
    return x_y_z_;
  }

  // Returns this three-dimensional vector value's x Cartesian component as a mutable value.
  constexpr double& Mutable_x() noexcept {
    return x_y_z_[0];
  }

  // Returns this three-dimensional vector value's y Cartesian component as a mutable value.
  constexpr double& Mutable_y() noexcept {
    return x_y_z_[1];
  }

  // Returns this three-dimensional vector value's z Cartesian component as a mutable value.
  constexpr double& Mutable_z() noexcept {
    return x_y_z_[2];
  }

  // Sets this three-dimensional vector value's x, y, and z Cartesian components to the given
  // values.
  ...
  // Sets this three-dimensional vector value's x Cartesian component to a given value.
  constexpr void Set_x(const double x) noexcept {
    x_y_z_[0] = x;
  }

  // Sets this three-dimensional vector value's y Cartesian component to a given value.
  constexpr void Set_y(const double y) noexcept {
    x_y_z_[1] = y;
  }

  // Sets this three-dimensional vector value's z Cartesian component to a given value.
  ...
  // Returns the magnitude (also known as the L2 norm) of this three-dimensional vector value.
  ...
  // vector value and another one.
  [[nodiscard]] constexpr Dyad Dyadic(const Vector& vector) const;

  // Returns the dyadic tensor product (also known as the outer product) of this three-dimensional
  // vector value and a given direction.
  [[nodiscard]] constexpr Dyad Dyadic(const PhQ::Direction& direction) const;

  // Returns the angle between this three-dimensional vector value and another one.
  [[nodiscard]] PhQ::Angle Angle(const Vector& vector) const;

  // Returns the angle between this three-dimensional vector value and a given direction.
  [[nodiscard]] PhQ::Angle Angle(const PhQ::Direction& direction) const;

  // Prints this three-dimensional vector value as a string. Components are printed to double
  ...
  // Prints this three-dimensional vector value as a string. Components are printed to a given
  // floating point precision.
