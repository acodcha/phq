...
// Three-dimensional symmetric dyadic tensor value in Cartesian coordinates. Contains six
// components: xx, xy = yx, xz = zx, yy, yz = zy, and zz.
class SymmetricDyad {
public:
  // Default constructor. Constructs a three-dimensional symmetric dyadic tensor value with
  // uninitialized xx, xy, xz, yy, yz, and zz Cartesian components.
  SymmetricDyad() = default;

  // Constructor. Constructs a three-dimensional symmetric dyadic tensor value from the given xx,
  ...
  // Constructor. Constructs a three-dimensional symmetric dyadic tensor value from a given array
  ...
  // Copy constructor. Constructs a three-dimensional symmetric dyadic tensor value by copying
  // another one.
  constexpr SymmetricDyad(const SymmetricDyad& other) = default;

  // Move constructor. Constructs a three-dimensional symmetric dyadic tensor value by moving
  // another one.
  constexpr SymmetricDyad(SymmetricDyad&& other) noexcept = default;

  // Copy assignment operator. Assigns this three-dimensional symmetric dyadic tensor value by
  // copying another one.
  constexpr SymmetricDyad& operator=(const SymmetricDyad& other) = default;

  // Move assignment operator. Assigns this three-dimensional symmetric dyadic tensor value by
  // moving another one.
  constexpr SymmetricDyad& operator=(SymmetricDyad&& other) noexcept = default;

  // Assignment operator. Assigns this three-dimensional symmetric dyadic tensor value by copying a
  // given array representing its xx, xy, xz, yy, yz, and zz Cartesian components.
  constexpr SymmetricDyad& operator=(const std::array<double, 6>& xx_xy_xz_yy_yz_zz) {
    xx_xy_xz_yy_yz_zz_ = xx_xy_xz_yy_yz_zz;
    return *this;
  }

  // Statically creates a three-dimensional symmetric dyadic tensor value with its xx, xy, xz, yy,
  ...
  // Returns this three-dimensional symmetric dyadic tensor value's xx, xy, xz, yy, yz, and zz
  ...
  // Returns this three-dimensional symmetric dyadic tensor value's xx Cartesian component.
  [[nodiscard]] constexpr double xx() const noexcept {
    return xx_xy_xz_yy_yz_zz_[0];
  }

  // Returns this three-dimensional symmetric dyadic tensor value's xy = yx Cartesian component.
  [[nodiscard]] constexpr double xy() const noexcept {
    return xx_xy_xz_yy_yz_zz_[1];
  }

  // Returns this three-dimensional symmetric dyadic tensor value's xz = zx Cartesian component.
  [[nodiscard]] constexpr double xz() const noexcept {
    return xx_xy_xz_yy_yz_zz_[2];
  }

  // Returns this three-dimensional symmetric dyadic tensor value's yx = xy Cartesian component.
  [[nodiscard]] constexpr double yx() const noexcept {
    return xx_xy_xz_yy_yz_zz_[1];
  }

  // Returns this three-dimensional symmetric dyadic tensor value's yy Cartesian component.
  [[nodiscard]] constexpr double yy() const noexcept {
    return xx_xy_xz_yy_yz_zz_[3];
  }

  // Returns this three-dimensional symmetric dyadic tensor value's yz = zy Cartesian component.
  [[nodiscard]] constexpr double yz() const noexcept {
    return xx_xy_xz_yy_yz_zz_[4];
  }

  // Returns this three-dimensional symmetric dyadic tensor value's zx = xz Cartesian component.
  [[nodiscard]] constexpr double zx() const noexcept {
    return xx_xy_xz_yy_yz_zz_[2];
  }

  // Returns this three-dimensional symmetric dyadic tensor value's zy = yz Cartesian component.
  [[nodiscard]] constexpr double zy() const noexcept {
    return xx_xy_xz_yy_yz_zz_[4];
  }

  // Returns this three-dimensional symmetric dyadic tensor value's zz Cartesian component.
  ...
  // Returns this three-dimensional symmetric dyadic tensor value's xx Cartesian component as a
  // mutable value.
  constexpr double& Mutable_xx() noexcept {
    return xx_xy_xz_yy_yz_zz_[0];
  }

  // Returns this three-dimensional symmetric dyadic tensor value's xy = yx Cartesian component as a
  // mutable value.
  constexpr double& Mutable_xy() noexcept {
    return xx_xy_xz_yy_yz_zz_[1];
  }

  // Returns this three-dimensional symmetric dyadic tensor value's xz = zx Cartesian component as a
  // mutable value.
  constexpr double& Mutable_xz() noexcept {
    return xx_xy_xz_yy_yz_zz_[2];
  }

  // Returns this three-dimensional symmetric dyadic tensor value's yx = xy Cartesian component as a
  // mutable value.
  constexpr double& Mutable_yx() noexcept {
    return xx_xy_xz_yy_yz_zz_[1];
  }

  // Returns this three-dimensional symmetric dyadic tensor value's yy Cartesian component as a
  // mutable value.
  constexpr double& Mutable_yy() noexcept {
    return xx_xy_xz_yy_yz_zz_[3];
  }

  // Returns this three-dimensional symmetric dyadic tensor value's yz = zy Cartesian component as a
  // mutable value.
  constexpr double& Mutable_yz() noexcept {
    return xx_xy_xz_yy_yz_zz_[4];
  }

  // Returns this three-dimensional symmetric dyadic tensor value's zx = xz Cartesian component as a
  // mutable value.
  constexpr double& Mutable_zx() noexcept {
    return xx_xy_xz_yy_yz_zz_[2];
  }

  // Returns this three-dimensional symmetric dyadic tensor value's zy = yz Cartesian component as a
  // mutable value.
  constexpr double& Mutable_zy() noexcept {
    return xx_xy_xz_yy_yz_zz_[4];
  }

  // Returns this three-dimensional symmetric dyadic tensor value's zz Cartesian component as a
  // mutable value.
  constexpr double& Mutable_zz() noexcept {
    return xx_xy_xz_yy_yz_zz_[5];
  }

  // Sets this three-dimensional symmetric dyadic tensor value's xx, xy, xz, yy, yz, and zz
  ...
  // Sets this three-dimensional symmetric dyadic tensor value's xx Cartesian component to a given
  // value.
  constexpr void Set_xx(const double xx) noexcept {
    xx_xy_xz_yy_yz_zz_[0] = xx;
  }

  // Sets this three-dimensional symmetric dyadic tensor value's xy = yx Cartesian component to a
  // given value.
  constexpr void Set_xy(const double xy) noexcept {
    xx_xy_xz_yy_yz_zz_[1] = xy;
  }

  // Sets this three-dimensional symmetric dyadic tensor value's xz = zx Cartesian component to a
  // given value.
  constexpr void Set_xz(const double xz) noexcept {
    xx_xy_xz_yy_yz_zz_[2] = xz;
  }

  // Sets this three-dimensional symmetric dyadic tensor value's yx = xy Cartesian component to a
  // given value.
  constexpr void Set_yx(const double yx) noexcept {
    xx_xy_xz_yy_yz_zz_[1] = yx;
  }

  // Sets this three-dimensional symmetric dyadic tensor value's yy Cartesian component to a given
  // value.
  constexpr void Set_yy(const double yy) noexcept {
    xx_xy_xz_yy_yz_zz_[3] = yy;
  }

  // Sets this three-dimensional symmetric dyadic tensor value's yz = zy Cartesian component to a
  // given value.
  constexpr void Set_yz(const double yz) noexcept {
    xx_xy_xz_yy_yz_zz_[4] = yz;
  }

  // Sets this three-dimensional symmetric dyadic tensor value's zx = xz Cartesian component to a
  // given value.
  constexpr void Set_zx(const double zx) noexcept {
    xx_xy_xz_yy_yz_zz_[2] = zx;
  }

  // Sets this three-dimensional symmetric dyadic tensor value's zy = yz Cartesian component to a
  // given value.
  constexpr void Set_zy(const double zy) noexcept {
    xx_xy_xz_yy_yz_zz_[4] = zy;
  }

  // Sets this three-dimensional symmetric dyadic tensor value's zz Cartesian component to a given
  // value.
  ...
  // Returns the determinant of this three-dimensional symmetric dyadic tensor value.
  [[nodiscard]] constexpr double Determinant() const noexcept {
    return xx() * (yy() * zz() - yz() * zy()) + xy() * (yz() * zx() - yx() * zz())
           + xz() * (yx() * zy() - yy() * zx());
  }

  // Returns the transpose of this three-dimensional symmetric dyadic tensor value.
  [[nodiscard]] constexpr const SymmetricDyad& Transpose() const noexcept {
    return *this;
  }

  // Returns the cofactors of this three-dimensional symmetric dyadic tensor value.
  ...
  // Returns the adjugate of this three-dimensional symmetric dyadic tensor value.
  [[nodiscard]] constexpr SymmetricDyad Adjugate() const {
    // Normally, this would be cofactors().transpose(), but since this is a symmetric dyad, the
    // transpose is not needed.
    return Cofactors();
  }

  // Returns the inverse of this three-dimensional symmetric dyadic tensor value if it exists, or
  // std::nullopt otherwise.
  [[nodiscard]] std::optional<SymmetricDyad> Inverse() const;

  // Prints this three-dimensional symmetric dyadic tensor value as a string. Components are printed
  ...
  // Prints this three-dimensional symmetric dyadic tensor value as a string. Components are printed
  // to a given floating point precision.
  ...
  // Serializes this three-dimensional symmetric dyadic tensor value as a JSON message.
  ...
  // Serializes this three-dimensional symmetric dyadic tensor value as an XML message.
  ...
  // Serializes this three-dimensional symmetric dyadic tensor value as a YAML message.
...
private:
  // Cartesian components of this three-dimensional symmetric dyadic tensor value.
