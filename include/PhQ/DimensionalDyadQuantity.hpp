...
public:
  ...
  [[nodiscard]] constexpr const Value::Dyad& Value() const noexcept {
    return value_;
  }

  // Value of this physical quantity expressed in a given unit of measure.
  [[nodiscard]] Value::Dyad Value(const U unit) const {
  ...
  template <U NewUnit>
  [[nodiscard]] constexpr Value::Dyad StaticValue() const {
...
protected:
  ...
  explicit constexpr DimensionalDyadQuantity(const Value::Dyad& value) : value_(value) {}
  ...
  DimensionalDyadQuantity(const Value::Dyad& value, const U unit) : value_(value) {
  ...
  constexpr DimensionalDyadQuantity(const DimensionalDyadQuantity& other) = default;

  // Move constructor. Constructs a dimensional dyadic tensor physical quantity
  // by moving another one.
  constexpr DimensionalDyadQuantity(DimensionalDyadQuantity&& other) noexcept = default;

  // Copy assignment operator. Assigns this dimensional dyadic tensor physical
  // quantity by copying another one.
  constexpr DimensionalDyadQuantity& operator=(const DimensionalDyadQuantity& other) = default;

  // Move assignment operator. Assigns this dimensional dyadic tensor physical
  // quantity by moving another one.
  constexpr DimensionalDyadQuantity& operator=(DimensionalDyadQuantity&& other) noexcept = default;
...
template <typename U>
inline std::ostream& operator<<(std::ostream& stream, const DimensionalDyadQuantity<U>& quantity) {
...
struct hash<PhQ::DimensionalDyadQuantity<U>> {
  inline size_t operator()(const PhQ::DimensionalDyadQuantity<U>& quantity) const {
